...
public class KeyCloakAdminService {
    ...
    public String createUser(String token, UserRequest userRequest) {
        ...
        body.put("username",userRequest.getUsername());
        body.put("firstName",userRequest.getFirstName());
        ...
        if(!HttpStatus.CREATED.equals(response.getStatusCode())) {
            throw new RuntimeException("Failed to create user Keycloak" + response.getBody());
        }
    ...
    public void assignRealmRoleToUser(String username,String roleName,String userId) {
        ...
        if(!response.getStatusCode().is2xxSuccessful()) {
            throw new RuntimeException("Failed to assign realm role" + roleName + " to user " + username +
